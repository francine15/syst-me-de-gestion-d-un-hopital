...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <form class="row g-3" action="/insertion" method="POST">
    @csrf
  <div class="col-md-6">
  ...
  <div class="col-12">
    ...
    <input type="tel" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor" name="tel">
  </div>
  <div class="col-12">
    <label for="inputAddress2" class="form-label">E-Mail</label>
    <input type="email" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor" name="email">
  </div>
  <div class="col-md-6">
    <label for="inputEmail4" class="form-label">Jour</label>
